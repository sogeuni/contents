...
|   |   |
|---|---|
|![[../images/note.gif|Note]]|_${parameter-default}_ and _${parameter:-default}_ are almost equivalent. The extra : makes a difference only when _parameter_ has been declared, but is null.|
...
See also [[special-chars#^EX58|Example 3-4]], [[zeros#^EX73|Example 31-2]], and [[contributed-scripts#^COLLATZ|Example A-6]].
...
|   |   |
|---|---|
|![[../images/note.gif|Note]]|Exceptions:
...
[[exitcodes#^EXITCODESREF|^1]: If $parameter is null in a non-interactive script, it will terminate with a [127 exit status]] (the Bash error code for "command not found").
