...
Awk breaks each line of input passed to it into [[special-chars#^FIELDREF|fields]]. By default, a field is a string of consecutive characters delimited by [[special-chars#^WHITESPACEREF|whitespace]], though there are options for changing this. Awk parses and operates on each separate field. This makes it ideal for handling structured text files -- especially tables -- data organized into consistent chunks, such as rows and columns.

[[varsubn#^SNGLQUO|Strong quoting]] and [[special-chars#^CODEBLOCKREF|curly brackets]] enclose blocks of awk code within a shell script.
...
4. [[wrapper#^COLTOTALER|Example 36-5]]
...
9. [[loops1#^FILEINFO|Example 11-3]]
10. [[extmisc#^BLOTOUT|Example 16-61]]
11. [[randomvar#^SEEDINGRANDOM|Example 9-16]]
12. [[moreadv#^IDELETE|Example 16-4]]
13. [[string-manipulation#^SUBSTRINGEX|Example 10-6]]
14. [[36.7. Assorted Tips#^SUMPRODUCT|Example 36-19]]
15. [[loops1#^USERLIST|Example 11-9]]
16. [[wrapper#^PRASC|Example 36-4]]
