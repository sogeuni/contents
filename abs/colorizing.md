...
The simplest, and perhaps most useful ANSI escape sequence is bold text, **\033[[escapingsection#^ESCP|1m ... \033[0m**. The \033 represents an [escape]], the "[1" turns on the bold attribute, while the "[0" switches it off. The "m" terminates each term of the escape sequence.
