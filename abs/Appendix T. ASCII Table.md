Traditionally, a book of this sort has an [[special-chars#^ASCIIDEF|ASCII]] Table appendix. This book does not. Instead, here are several short scripts, each of which generates a complete ASCII table.
