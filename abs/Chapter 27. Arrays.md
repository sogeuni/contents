...
Many of the standard [[string-manipulation#^STRINGMANIP|string operations]] work on arrays.
...
The relationship of **`${array_name[@]}`** and **`${array_name[*]}`** is analogous to that between [[internalvariables#^APPREF|$@ and $*]]. This powerful array notation has a number of uses.
...
Embedded arrays in combination with [[37.1. Bash, version 2#^VARREFNEW|indirect references]] create some fascinating possibilities
