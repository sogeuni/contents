...
A _here document_ is a special-purpose code block. It uses a form of [[io-redirection#^IOREDIRREF|I/O redirection]] to feed a command list to an interactive program or a command, such as [[communications#^FTPREF|ftp]], [[basic#^CATREF|cat]], or the _ex_ text editor.
...
Quoting or escaping the "limit string" at the head of a here document disables parameter substitution within its body. The reason for this is that _quoting/escaping the limit string_ effectively [[escapingsection#^ESCP|escapes]] the $, `, and \ [[special-chars#^SCHARLIST|special characters]], and causes them to be interpreted literally. (Thank you, Allen Halsey, for pointing this out.)
