...
As a simple example, consider this alternative to the [[internal#^ECHOGREPREF|echo-grep]] construction.
...
Or, in combination with [[internal#^READREF|read]]:
...
It is, of course, possible to feed the output of a _here string_ into the stdin of a [[loops#^LOOPREF00|loop]].
...
Exercise: Find other uses for _here strings_, such as, for example, [[mathc#^GOLDENRATIO|feeding input to _dc_]].
