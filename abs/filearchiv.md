...
See also [[loops1#^FILEINFO|Example 11-3]].
...
[[special-chars#^PIPEREF|Piping]] _openssl_ to/from [[filearchiv#^TARREF|tar]] makes it possible to encrypt an entire directory tree.
