Emmanual Rouat contributed the following example of parsing and transforming _filenames_ and, in particular, [[special-chars#^PATHNAMEREF|pathnames]]. It draws heavily on the functionality of _sed_.
