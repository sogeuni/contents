...
Of what practical use is indirect referencing of variables? It gives Bash a little of the functionality of [pointers](varsubn.html#POINTERREF) in _C_, for instance, in [[bash-ver2#^RESISTOR|table lookup]]. And, it also has some other very interesting applications. . . .
